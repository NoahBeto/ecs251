...
class CompareVisuals:
    def __init__(self, iouring_dir='benchmark_results_iouring_10KB', epoll_dir='benchmark_results_epoll_10KB'):
    ...
    def load_data(self):
        ...
        for label, dir_ in [('iouring', self.iouring_dir), ('epoll', self.epoll_dir)]:
            ...
            for c in self.concurrency_levels:
                fpath = os.path.join(dir_, f'{prefix}_c{c}_10kb.txt')
    ...
    def plot_comparison(self):
        ...
        plt.savefig('benchmark_comparison_10KB.png', dpi=300, bbox_inches='tight')
        print("✓ Saved: benchmark_comparison_10KB.png")
        plt.show()
        # ax = axes[1,1]
        # top_n = 6
        ...
        # plt.savefig('benchmark_comparison_10KB.png', dpi=300)
        # print("✓ Saved: benchmark_comparison_10KB.png")
        # plt.show()
