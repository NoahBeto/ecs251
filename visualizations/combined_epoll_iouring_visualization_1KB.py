...
class CompareVisuals:
    def __init__(self, iouring_dir='benchmark_results_iouring_1KB', epoll_dir='benchmark_results_epoll_1KB'):
    ...
    def load_data(self):
        ...
        for label, dir_ in [('iouring', self.iouring_dir), ('epoll', self.epoll_dir)]:
            ...
            for c in self.concurrency_levels:
                fpath = os.path.join(dir_, f'{prefix}_c{c}_1kb.txt')
    ...
    def plot_comparison(self):
        ...
        plt.savefig('benchmark_comparison_1KB.png', dpi=300, bbox_inches='tight')
        print("✓ Saved: benchmark_comparison_1KB.png")
        plt.show()
        ...
        # plt.savefig('benchmark_comparison_1KB.png', dpi=300)
        # print("✓ Saved: benchmark_comparison_1KB.png")
        # plt.show()
