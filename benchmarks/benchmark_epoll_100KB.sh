...
# Benchmark for epoll file server - 100KB FILE ONLY
# Based on ECS 251 evaluation plan

OUTPUT_DIR="benchmark_results_epoll_100KB"
mkdir -p $OUTPUT_DIR
...
echo "Run: python3 visualizations/visualize_results_epoll_100KB.py to generate graphs"
echo "========================================"