...
# Benchmark for io_uring file server - 1KB FILE ONLY
# Based on ECS 251 evaluation plan

OUTPUT_DIR="benchmark_results_iouring_1KB"
mkdir -p $OUTPUT_DIR

echo "========================================"
echo "1KB File Performance Benchmark"
echo "========================================"
echo ""
...
# ---------------------------------------------------------------
# Test 1: Throughput vs Concurrency (1KB file)
...
# ---------------------------------------------------------------
echo "=== Test 7: CPU Utilization vs Concurrency (1KB file) ==="
...
echo "Run: python3 visualizations/visualize_results_iouring_1KB.py to generate graphs"
echo "========================================"